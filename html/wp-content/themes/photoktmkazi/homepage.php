...
<header id="home">
  <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
      <div class="item active parallax-window" data-positionY="0px" data-parallax="scroll" data-speed="0.1" data-iosFix="true" data-image-src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/bg2.jpg" title="Patan Durbar Square by Kevin Bubriski"> 
        <!-- <div class="caption">
  ...
  <div class="main-nav">
    <div class="container">
      <div class="navbar-header">
        ...
        <h1> <img class="img-responsive logo-sm" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/pktmsmall.png" alt="logo"> 
  ...
  <div class="container">
    ...
    <div class="row 2col">
      ...
      <div class="col-md-6 col-right wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="700ms">
        ...
        <h3>FOLLOW US ON:</h3>
        <a href="http://www.facebook.com/photoktm" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/facebooki.png" width="10" height="21" alt="Facebook" title="Facebook" /></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://www.twitter.com/photoktm" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/twitteri.png" width="25" height="21" alt="Twitter" title="Twitter" /></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://www.instagram.com/photoktm" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/instagrami.png" width="21" height="21" alt="Instagram" title="Instagram"/></a> </div>
    </div>
    <!-- /.row -->
    <div id="partner-logo" class="text-center wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">
      <div class="row">
        <div class="col-xs-12"> <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/logos.png" alt="" class="responsive-img"> </div>
      </div>
    </div>
  </div>
  <!-- /.container --> 
...
<!--/#services-->
<div id="submit" class="section parallax-img parallax-window" data-positionY="0px" data-parallax="scroll" data-iosFix="true" data-image-src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/patanmuseum.jpg" data-naturalHeight="auto" title="Side Talk. Photo: Bikas Rauniar Collection/Nepal Picture Library"></div>
<!-- /.parallax-img -->
...
<!-- /.submit-form -->
<div id="visit-kathmandu" class="section parallax-img parallax-window" data-positionY="0px" data-parallax="scroll" data-iosFix="true" data-image-src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/thesthapitclan.jpg" data-naturalHeight="auto" title="The Sthapit Clan. Photo: Sanjay Sthapit Collection/Nepal Picture Library"></div>
<!-- /.parallax-img -->
...
<!--/#visit-kathmandu -->
<div id="support" class="section parallax-img parallax-window" data-positionY="0px" data-parallax="scroll" data-iosFix="true" data-image-src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/basantapur.jpg" data-naturalHeight="auto" title="Kathmandu Durbar Square. Photo: Bikas Rauniar Collection/Nepal Picture Library"></div>
<!-- /.parallax-img -->
<section class="pink-bg">
  <div class="container">
    <div class="row">
...
<!--/#Contact Us-->
<section id="social-icons-container"> <a href="http://www.facebook.com/photoktm" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/facebook.png" alt="Facebook" title="Facebook"></a> <a href="http://www.twitter.com/photoktm" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/twitter.png" alt="Twitter" title="Twitter"></a> <a href="http://www.instagram.com/photoktm" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/instagram.png" alt="Instagram" title="Instagram"></a> </section>
<?php get_footer(); ?>